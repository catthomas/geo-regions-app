 ...
 * in a list with their geographic neighbors.
 * @version 1.0
 */
public class GeoNeighborhoodListView extends JFrame {
	/**
	 * Unique ID in order for this class to be written to files
	 * directly as an object.
	 */
	private static final long serialVersionUID = -3970974765758594503L;
	 ...
	 */
	public GeoNeighborhoodListView(Mappable<? extends Region> chosenRegion, int breadth, int length,
			RegionModel model){
		//Set the model
		this.model = model; 
		...
		//Create JLabel
		JLabel jlTitle = new JLabel("Geographic Neighborhood for " + chosenRegion.getName()
		...
		setTitle("Geographic Neighborhood List");
	...
	public void populateGeoNeighborModel(Mappable<? extends Region> region, int breadth, int length) {
		...
		ArrayList<Mappable<? extends Region>> neighborList = generateGeoNeighbors(region, breadth, length);
	 ...
	 */
	public ArrayList<Mappable<? extends Region>> 
